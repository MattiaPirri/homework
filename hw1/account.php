...
<head>
    <title>Pirri shop - Account</title>
    <meta charset="utf-8">
        ...
        <nav>
                                ...
                                <div id="utente-navbar">
                                    <?php
                                        if (isset($_SESSION["_nome_cliente"])) {
                                            ...
                                            echo "<a href= \"login.php?redirect=account.php\">Accedi</a>"; 
                                        }
                                    ?>
                                </div>
                            </div>
                            ...
                            <div id="hover-desideri">
                                ...
                                <?php
                                        if (isset($_SESSION["_nome_cliente"])) { 
                                            ...
                                            echo "<div class=\"not-logged\"><a href=\"login.php?account.php\">Accedi</a> per vedere la tua lista dei desideri</div>"; 
                                        }
                                    ?>
                                ...
                                <div id="carrello-navbar">
                                    <?php
                                        if (isset($_SESSION["_nome_cliente"])) { 
                                            ...
                                            echo "<div class=\"not-logged\"><a href=\"login.php?account.php\">Accedi</a> per vedere il tuo carrello</div>"; 
                                        }
                                    ?>
                                </div>
                            </div>
            ...
            <div id="menu-mobile" class="hidden">
                ...
                <?php   if(isset($_SESSION['_id_cliente'])) 
                            ...
                            echo "<a id=\"menu-mobile-login\" href=\"login.php?redirect=account.php\">Login</a>";
                ?> 
