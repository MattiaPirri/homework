...
<head>
    <title>Pirri shop - Categorie</title>
    <meta charset="utf-8">
...
<body>
        ...
        <nav>
            ...
            <div id="menu">
                <div id="menu-contenuto">
                    <a href="categorie.php">
                        <div href="" id="categorie">Categorie▾
                            <div id="categoria">
                            </div>
                        </div>
                    </a>
                                ...
                                <div id="utente-navbar">
                                    <?php
                                        if (isset($_SESSION["_nome_cliente"])) {
                                            ...
                                            if(isset($_GET['c'])){
                                                $c=$_GET['c'];
                                                echo "<a href= \"login.php?redirect=categorie.php?c=$c\">Accedi</a>"; 
                                            }else echo "<a href= \"login.php?redirect=categorie.php\">Accedi</a>"; 
                                        }
                                    ?>
                                </div>
                            </div>
                            ...
                            <div id="hover-desideri">
                                ...
                                <?php
                                        if (isset($_SESSION["_nome_cliente"])) { 
                                            ...
                                            if(isset($_GET['c'])){
                                                $c=$_GET['c'];
                                                echo "<div class=\"not-logged\"><a href=\"login.php?redirect=categorie.php?c=$c\">Accedi</a> per vedere la tua lista dei desideri</div>"; 
                                            }else echo "<div class=\"not-logged\"><a href=\"login.php?redirect=categorie.php\">Accedi</a> per vedere la tua lista dei desideri</div>"; 
                                ...
                                <div id="carrello-navbar">
                                    <?php
                                        if (isset($_SESSION["_nome_cliente"])) { 
                                            ...
                                            if(isset($_GET['c'])){
                                                $c=$_GET['c'];
                                                echo "<div class=\"not-logged\"><a href=\"login.php?redirect=categorie.php?c=$c\">Accedi</a> per vedere il tuo carrello</div>"; 
                                            }else  echo "<div class=\"not-logged\"><a href=\"login.php?redirect=categorie.php\">Accedi</a> per vedere il tuo carrello</div>";    
                                        }
                                    ?>
                                </div>
                            </div>
            ...
            <div id="menu-mobile" class="hidden">
                ...
                <?php   if(isset($_SESSION['_id_cliente'])) 
                            ...
                            $c=$_GET['c'];
                            echo "<a id=\"menu-mobile-login\" href=\"login.php?redirect=categorie.php?c=$c\">Login</a>";
                        }
                        else echo "<a id=\"menu-mobile-login\" href=\"login.php?redirect=categorie.php\">Login</a>";
                ?> 
    ...
    <article>
        <h1 id="title-categories" class="hidden">Categorie</h1>
        <section id="categories">
            <div id="loader-categorie"></div>
        </section>
        <div id="title-categoria"></div>
        <section id="prodotti">
            <div id="loader-categoria"></div>
        </section>
        <span id="load-more" class="hidden">Scorri per caricare altri risultati</span>
        <div id="loader-more-categoria"></div>
        <section id="modal-view" class="hidden">
            <div class="modal-content">
                <h1>Non sei autenticato</h1>
                <?php if(isset($_GET['c'])) {
                            $c=$_GET['c']; 
                            echo "<a href=\"login.php?redirect=categorie.php?c=$c\" >Accedi</a> per utilizzare questa funzione";
                        }else{
                            echo "<a href=\"login.php?redirect=categorie.php\" >Accedi</a> per utilizzare questa funzione";
                        }
                    ?>
            </div>
        </section>
