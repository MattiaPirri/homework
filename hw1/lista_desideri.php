<?php
    ...
    if (!checkAuth()) {
        header("Location: login.php?redirect=lista_desideri.php");
        exit;
    }  
?>
<!DOCTYPE html>
...
<head>
    <title>Pirri shop - Lista desideri</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="style/lista-desideri.css">
    <script src="js/main.js" defer></script>
    <script src="js/search.js" defer></script>
    <script src="js/item-prodotto.js" defer></script>
    <script src="js/lista-desideri.js" defer></script>
</head>
