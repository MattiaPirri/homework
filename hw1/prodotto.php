...
<head>
    ...
    <link rel="stylesheet" href="style/prodotto.css">
    <script src="js/main.js" defer></script>
    <script src="js/search.js" defer></script>
    <script src="js/item-prodotto.js" defer></script>
    <script src="js/prodotto.js" defer></script>
</head>
...
<body>
                                ...
                                <div id="utente-navbar">
                                    <?php
                                        if (isset($_SESSION["_nome_cliente"])) {
                                            ...
                                            $ean = $_GET['EAN'];
                                            echo "<a href= \"login.php?redirect=prodotto.php?EAN=$ean\">Accedi</a>"; 
                                        }
                                    ?>
                                </div>
                            </div>
                            ...
                            <div id="hover-desideri">
                                ...
                                <?php
                                        if (isset($_SESSION["_nome_cliente"])) { 
                                            ...
                                            echo "<div class=\"not-logged\"><a href=\"login.php?redirect=prodotto.php?EAN=$ean\">Accedi</a> per vedere la tua lista dei desideri</div>"; 
                                        }
                                    ?>
                                ...
                                <div id="carrello-navbar">
                                    <?php
                                        if (isset($_SESSION["_nome_cliente"])) { 
                                            ...
                                            echo "<div class=\"not-logged\"><a href=\"login.php?redirect=prodotto.php?EAN=$ean\">Accedi</a> per vedere il tuo carrello</div>"; 
                                        }
                                    ?>
                                </div>
                            </div>
    ...
    <article>
        <a href="categorie.php">Categorie</a>><a id="link-categoria"></a>
        <div id="wrapper-prodotto"></div>
        <div id="loader"></div>
        <section id="modal-view" class="hidden">
            <div class="modal-content">
                <h1>Non sei autenticato</h1>
                <a href="login.php?redirect=prodotto.php?EAN=<?php echo $_GET['EAN'];?>">Accedi</a> per utilizzare questa funzione
            </div>
        </section>
        ...
        <section id="modal-view-leave-review" class="hidden">
            <div class="modal-content">
                <h1>Scrivi la tua recensione</h1>
                <div id="clickable">
                    <div id="scelta-stelle">
                        <input type="radio" name="stelle" id="stella1" value="5">
                        <label for="stella1"></label>
                        <input type="radio" name="stelle" id="stella2" value="4">
                        <label for="stella2"></label>
                        <input type="radio" name="stelle" id="stella3" value="3">
                        <label for="stella3"></label>
                        <input type="radio" name="stelle" id="stella4" value="2">
                        <label for="stella4"></label>
                        <input type="radio" name="stelle" id="stella5" value="1">
                        <label for="stella5"></label>
                    </div>
                    Titolo
                    <input type="text" name="titolo" id="titolo-recensione" placeholder="Inserisci il titolo">
                    Recensione
                    <textarea name="recensione" id="" cols="30" rows="8" maxlength="255" placeholder="Come valuteresti questo articolo?"></textarea>
                </div>
