...
<head>
    <title>Pirri shop - Carrello</title>
    <meta charset="utf-8">
...
<body>
        ...
        <nav>
                                ...
                                <div id="utente-navbar">
                                    <?php
                                        if (isset($_SESSION["_nome_cliente"])) {
                                            ...
                                            echo "<a href= \"login.php?redirect=carrello.php\">Accedi</a>"; 
                                        }
                                    ?>
                                </div>
                            </div>
                            ...
                            <div id="hover-desideri">
                                ...
                                <?php
                                        if (isset($_SESSION["_nome_cliente"])) { 
                                            ...
                                            echo "<div class=\"not-logged\"><a href=\"login.php?carrello.php\">Accedi</a> per vedere la tua lista dei desideri</div>"; 
                                        }
                                    ?>
                                ...
                                <div id="carrello-navbar">
                                    <?php
                                        if (isset($_SESSION["_nome_cliente"])) { 
                                            ...
                                            echo "<div class=\"not-logged\"><a href=\"login.php?carrello.php\">Accedi</a> per vedere il tuo carrello</div>"; 
                                        }
                                    ?>
                                </div>
                            </div>
            ...
            <div id="menu-mobile" class="hidden">
                ...
                <?php   if(isset($_SESSION['_id_cliente'])) 
                            ...
                            echo "<a id=\"menu-mobile-login\" href=\"login.php?redirect=carrello.php\">Login</a>";
                ?> 
    ...
    <article>
        ...
        <div id="prezzo"></div>
        <div id="peso"></div>
        <button id="completa" class="hidden">Procedi con l'ordine</button>
    </article>
    <footer>
        <div id="footer">
            <div class="item">
