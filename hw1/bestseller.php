...
<head>
    <title>Pirri shop - Bestseller</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="style/bestseller.css">
    <script src="js/main.js" defer></script>
    <script src="js/search.js" defer></script>
    <script src="js/item-prodotto.js" defer></script>
    <script src="js/bestseller.js" defer></script>
</head>
    ...
    <header>
        <nav>
                                ...
                                <div id="utente-navbar">
                                    <?php
                                        if (isset($_SESSION["_nome_cliente"])) {
                                            ...
                                            echo "<a href= \"login.php?redirect=bestseller.php\">Accedi</a>"; 
                                        }
                                    ?>
                                </div>
                            </div>
                            ...
                            <div id="hover-desideri">
                                ...
                                <?php
                                        if (isset($_SESSION["_nome_cliente"])) { 
                                            ...
                                            echo "<div class=\"not-logged\"><a href=\"login.php?bestseller.php\">Accedi</a> per vedere la tua lista dei desideri</div>"; 
                                        }
                                    ?>
                                ...
                                <div id="carrello-navbar">
                                    <?php
                                        if (isset($_SESSION["_nome_cliente"])) { 
                                            ...
                                            echo "<div class=\"not-logged\"><a href=\"login.php?bestseller.php\">Accedi</a> per vedere il tuo carrello</div>"; 
                                        }
                                    ?>
                                </div>
                            </div>
            ...
            <div id="menu-mobile" class="hidden">
                ...
                <?php if(isset($_SESSION['_id_cliente'])) echo "<a id=\"menu-mobile-logout\" href=\"logout.php\">Logout</a>";?> 
    ...
    <article>
        ...
        <section id="modal-view" class="hidden">
            <div class="modal-content">
                ...
                <a href="login.php?bestseller.php">Accedi</a> per utilizzare questa funzione
            </div>
        </section>
